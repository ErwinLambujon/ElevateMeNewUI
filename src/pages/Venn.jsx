...
function Venn() {
    ...
    const storedFields = sessionStorage.getItem("vennTextFields");
  ...
  const [ProblemStatements, setProblemStatements] = useState(() => {
    const storedStatements = sessionStorage.getItem("generatedProblemStatements");
  ...
  const [isLoading, setIsLoading] = useState(false);
	const [selectedProblemStatements, setSelectedProblemStatements] = useState({
	 ...
	 useEffect(() => {
    sessionStorage.setItem("vennTextFields", JSON.stringify(textFields));
  }, [textFields]);

	  useEffect(() => {
    sessionStorage.setItem("generatedProblemStatements", JSON.stringify(ProblemStatements));
  }, [ProblemStatements]);
